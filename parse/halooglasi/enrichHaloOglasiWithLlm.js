...
console.log(`[enrich-llm-halooglasi] candidates: ${posts.length}, enriching: ${toEnrich.length}`);
console.log(`[enrich-llm-halooglasi] model: ${args.ollamaModel}, url: ${args.ollamaUrl}`);

if (toEnrich.length === 0) {
  console.log('[enrich-llm-halooglasi] nothing to do');
  process.exit(0);
}
...
console.log(`[enrich-llm-halooglasi] done. enriched: ${enriched}, failed: ${failed}, total posts: ${countPosts(args.source)} in ${DB_PATH}`);